...
- Usage: Reference from command with `@/Users/admin/Applications/swiss-truth-mcp/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/admin/Applications/swiss-truth-mcp/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/admin/Applications/swiss-truth-mcp/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
