...
@/Users/admin/Applications/swiss-truth-mcp/.claude/get-shit-done/references/ui-brand.md
@/Users/admin/Applications/swiss-truth-mcp/.claude/get-shit-done/references/revision-loop.md
...
**If found:**
1. Read template: `/Users/admin/Applications/swiss-truth-mcp/.claude/get-shit-done/templates/VALIDATION.md`
...
${TDD_MODE === 'true' ? `
<tdd_mode_active>
**TDD Mode is ENABLED.** Apply TDD heuristics from @/Users/admin/Applications/swiss-truth-mcp/.claude/get-shit-done/references/tdd.md to all eligible tasks:
