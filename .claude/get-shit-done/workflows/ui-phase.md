...
```markdown
Read /Users/admin/Applications/swiss-truth-mcp/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: /Users/admin/Applications/swiss-truth-mcp/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read /Users/admin/Applications/swiss-truth-mcp/.claude/agents/gsd-ui-checker.md for instructions.
