...
<template>
@/Users/admin/Applications/swiss-truth-mcp/.claude/get-shit-done/templates/UAT.md
</template>
...
Read and follow `/Users/admin/Applications/swiss-truth-mcp/.claude/get-shit-done/workflows/transition.md`.
...
```bash
node "/Users/admin/Applications/swiss-truth-mcp/.claude/get-shit-done/bin/gsd-tools.cjs" audit-open --json 2>/dev/null
```
...
- Follow @/Users/admin/Applications/swiss-truth-mcp/.claude/get-shit-done/workflows/diagnose-issues.md
