...
```
Task(
  prompt="Read /Users/admin/Applications/swiss-truth-mcp/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/admin/Applications/swiss-truth-mcp/.claude/get-shit-done/templates/VALIDATION.md`
