...
```bash
INIT=$(node "/Users/admin/Applications/swiss-truth-mcp/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/admin/Applications/swiss-truth-mcp/.claude/get-shit-done/templates/spec.md.
