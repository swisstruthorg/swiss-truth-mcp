...
Reference full template: `/Users/admin/Applications/swiss-truth-mcp/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/Users/admin/Applications/swiss-truth-mcp/.claude/get-shit-done/templates/state.md`.
