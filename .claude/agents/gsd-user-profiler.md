...
<reference>
@/Users/admin/Applications/swiss-truth-mcp/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/Users/admin/Applications/swiss-truth-mcp/.claude/get-shit-done/references/user-profiling.md` to load:
