...
Use template from `/Users/admin/Applications/swiss-truth-mcp/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/Users/admin/Applications/swiss-truth-mcp/.claude/get-shit-done/templates/UI-SPEC.md`
