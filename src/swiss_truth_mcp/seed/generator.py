...
DOMAINS = {
    ...
    # ── Neue Domains (Phase 10 — Coverage Fill) ──────────────────────────────
    "swiss-taxation": {
        "name": "Schweizer Steuern",
        "description": "Steuerrecht, MWST, Einkommenssteuer, Unternehmenssteuer und kantonale Steuerpolitik der Schweiz",
        "topics": [
            "Einkommenssteuer — Bund, Kantone, Gemeinden",
            "Mehrwertsteuer (MWST) — Sätze und Ausnahmen",
            "Unternehmenssteuer — Gewinn- und Kapitalsteuer",
            "Verrechnungssteuer — Rückerstattungsanspruch",
            "Erbschafts- und Schenkungssteuer Schweiz",
            "Steuerharmonisierungsgesetz (StHG)",
            "Steuererklärung — Fristen und Verfahren",
            "Steuerabkommen (DBA) — Schweiz und EU",
            "MWST-Abrechnung für Unternehmen",
            "Kantonale Steuerbelastung — Vergleich",
        ],
        "faq_urls": [
            "https://www.estv.admin.ch/estv/de/home/mehrwertsteuer.html",
            "https://www.estv.admin.ch/estv/de/home/direkte-bundessteuer.html",
        ],
        "wiki_topics": ["Steuersystem der Schweiz", "Mehrwertsteuer"],
        "wiki_lang": "de",
    },
    "data-protection": {
        "name": "Datenschutz & Privatsphäre",
        "description": "Schweizer Datenschutzgesetz (revDSG), DSGVO, Datenschutz-Grundlagen und Compliance",
        "topics": [
            "Revidiertes Datenschutzgesetz (revDSG) — Grundprinzipien",
            "DSGVO vs. Schweizer DSG — Unterschiede",
            "Datenschutz-Grundsätze: Zweckbindung, Verhältnismässigkeit",
            ...
            "International Datentransfer — Standardvertragsklauseln",
            "EDÖB (Eidgenössischer Datenschutzbeauftragter)",
        ],
        "faq_urls": [
            "https://www.edoeb.admin.ch/edoeb/de/home/datenschutz/recht/revdsg.html",
            "https://www.edoeb.admin.ch/edoeb/de/home/datenschutz/recht.html",
        ],
        "wiki_topics": ["Datenschutz-Grundverordnung", "Datenschutzgesetz (Schweiz)"],
        "wiki_lang": "de",
    },
    "swiss-innovation": {
        "name": "Schweizer Innovation & Startups",
        "description": "Innovationsförderung, Startup-Ökosystem, ETH-Transfer und Schweizer Technologiepolitik",
        "topics": [
            "ETH Zürich und EPFL — Spin-offs und Technologietransfer",
            "Innosuisse (Schweizerische Agentur für Innovationsförderung)",
            "Swiss Startup Ecosystem — Rankings und Hubs",
            "Schweizer Risikokapital und Venture Capital",
            "Innovationsindex Schweiz — europäischer Vergleich",
            "Deeptech Startups Schweiz — Pharma, MedTech, CleanTech",
            "Swiss Made Software und ICT-Sektor",
            "Patentanmeldungen Schweiz — IGE/EPO Statistiken",
            "Startup-Finanzierung: Pre-Seed bis Series B",
            "Regulatorische Sandbox Schweiz — FinTech und HealthTech",
        ],
        "faq_urls": [
            "https://www.innosuisse.ch/inno/de/home.html",
            "https://www.ige.ch/de/uebersicht.html",
        ],
        "wiki_topics": ["Innosuisse", "ETH Zürich"],
        "wiki_lang": "de",
    },
    "swiss-real-estate": {
        "name": "Schweizer Immobilien",
        "description": "Wohnungsmarkt, Miete, Eigenheim und Immobilienrecht in der Schweiz",
        "topics": [
            "Referenzzinssatz — Auswirkung auf Mietzins",
            "Mietzinserhöhung — Voraussetzungen und Verfahren",
            "Eigenmietwert — Besteuerung selbstgenutzten Wohneigentums",
            "Lex Koller — Beschränkungen für Ausländer",
            "Wohnungsmarkt Schweiz — Leerstandsquoten",
            "Hypotheken — Festhypothek vs. SARON-Hypothek",
            "Eigenheimfinanzierung — 20% Eigenkapital Regel",
            "Stockwerkeigentum (StWE) — Rechte und Pflichten",
            "Mietrecht — OR Artikel 253-274",
            "Nebenkosten und Betriebskosten im Mietverhältnis",
        ],
        "faq_urls": [
            "https://www.mietrecht.ch",
            "https://www.snb.ch/de/ifor/stat/statpub/wph/id/statpub_wph_current",
        ],
        "wiki_topics": ["Wohnungsmarkt", "Miete (Schweiz)"],
        "wiki_lang": "de",
    },
    "swiss-crypto": {
        "name": "Schweizer Krypto & FinTech",
        "description": "Krypto Valley Zug, FINMA-Regulierung, Schweizer DLT-Gesetz und FinTech-Hub",
        "topics": [
            "Crypto Valley Zug — Ökosystem und wichtige Unternehmen",
            "FINMA ICO-Wegleitung — Token-Kategorisierung",
            "DLT-Gesetz Schweiz (2021) — wichtigste Neuerungen",
            "Schweizer Blockchain-Unternehmen — Überblick",
            "FINMA Banking License für Krypto-Unternehmen",
            "SIX Digital Exchange (SDX) — Regulated DLT Trading",
            "SNB und digitaler Franken (CBDC Pilotprojekte)",
            "Krypto-Besteuerung Schweiz — ESTV-Merkblatt",
            "Swiss Franc Stablecoins — regulatorischer Status",
            "AML-Pflichten für Virtual Asset Service Providers (VASP)",
        ],
        "faq_urls": [
            "https://www.finma.ch/de/dokumentation/dossier/dossier-fintech/",
            "https://www.estv.admin.ch/estv/de/home.html",
        ],
        "wiki_topics": ["Blockchain", "Kryptowährung"],
        "wiki_lang": "de",
    },
    "ai-safety-en": {
        "name": "AI Safety (EN)",
        "description": "AI alignment, safety research, model evaluation, and AI governance — English content",
        "topics": [
            "AI alignment — value alignment and specification gaming",
            "Constitutional AI (CAI) — Anthropic's safety approach",
            "RLHF and its limitations for alignment",
            "Mechanistic interpretability — circuits and features",
            "AI red-teaming — adversarial testing methodologies",
            "Frontier model evaluation — METR, HELM, BIG-bench",
            "EU AI Act — prohibited AI systems and high-risk categories",
            "NIST AI RMF — Govern, Map, Measure, Manage",
            "Deceptive alignment — risks and detection approaches",
            "Model cards and transparency standards",
        ],
        "faq_urls": [
            "https://www.anthropic.com/research",
            "https://www.nist.gov/artificial-intelligence",
        ],
        "wiki_topics": ["AI safety", "AI alignment", "Existential risk from artificial general intelligence"],
        "wiki_lang": "en",
    },
    "eu-law-en": {
        "name": "EU Law (EN)",
        "description": "EU legislation in English — GDPR, AI Act, DMA, DSA and EU court decisions",
        "topics": [
            ...
            "Digital Markets Act — gatekeeper designation criteria",
            "Digital Services Act — content moderation obligations",
            "NIS2 Directive — cybersecurity requirements for operators",
            "EU Whistleblower Protection Directive",
            "European Health Data Space regulation",
            "CJEU rulings on data transfers — Schrems I & II",
            "ePrivacy Directive — cookie and tracking rules",
        ],
        "faq_urls": [
            "https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX%3A32016R0679",
            "https://digital-strategy.ec.europa.eu/en/policies/regulatory-framework-ai",
        ],
        "wiki_topics": ["General Data Protection Regulation", "AI Act", "Digital Markets Act"],
        "wiki_lang": "en",
    },
    "ai-ml-en": {
        "name": "AI/ML (EN)",
        "description": "Machine learning, deep learning, LLMs and AI research — English content",
        "topics": [
            "Transformer architecture — attention mechanism explained",
            "Large Language Models — GPT-4, Claude, Gemini comparison",
            "Retrieval-Augmented Generation (RAG) — architecture and benefits",
            "Fine-tuning vs. in-context learning — trade-offs",
            "Embeddings and vector databases — use cases",
            "Agent frameworks — ReAct, Chain-of-Thought, Tool Use",
            "Multimodal AI — vision-language models",
            "AI evaluation benchmarks — MMLU, HumanEval, MATH",
            "Diffusion models — Stable Diffusion, DALL-E mechanism",
        ...
        "wiki_topics": ["Large language model", "Transformer (machine learning model)", "Retrieval-augmented generation"],
        "wiki_lang": "en",
    },
    "nutrition-food": {
